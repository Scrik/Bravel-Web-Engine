...
WBBLANG['ru']= CURLANG = {
	...
	modal_link_url: "URL ссылки (все открываются в новом окне)",
...
//			direction:			"ltr",
			...
			buttons: 			"bold,italic,underline,strike,sup,sub,|,img,video,link,|,bullist,numlist,smilebox,|,fontcolor,fontsize,fontfamily,|,justifyleft,justifycenter,justifywidth,justifyright,|,quote,code,offtop,table,removeFormat",
			allButtons: {
				bold : {
					title: CURLANG.bold,
				...
				fontcolor: {
					...
					valueBBname: "color",
					subInsert: true,
					colors: "#333333,#444444,#666666,#999999,#b6b6b6,#cccccc,#d8d8d8,#efefef,#f4f4f4,#ffffff,-, \
				...
				fontsize: {
					...
					options: "fs_verysmall,fs_small,fs_normal,fs_big,fs_big2,fs_verybig"
				},
				fontfamily: {
					type: 'select',
				...
				justifywidth: {
					title: CURLANG.justifywidth,
					buttonHTML: '<span class="fonticon ve-tlb-textwidth1">\uE014</span>',
					groupkey: 'align',
					transform: {
				...
				fs_big2: {
					title: CURLANG.fs_big2,
					buttonText: "fs5",
					excmd: 'fontSize',
					exvalue: "5",
					transform: {
						'<font size="5">{SELTEXT}</font>':'[size=185]{SELTEXT}[/size]'
					}
				},
				fs_verybig: {
